...
import ButtonOutline from "../pages/introduction/misc/ButtonOutline";
      ...
      >
        <nav className="max-w-screen-xl px-6 sm:px-8 lg:px-16 mx-auto grid grid-flow-col py-3 sm:py-4">
          ...
          <div className="col-start-10 gap-3 col-end-12 font-medium flex justify-end items-center">
            <Link to="/login">
              <p className="text-black-600 capitalize tracking-wide hover:text-purple-500 transition-all">
                Sign In
              </p>
            </Link>
        ...
        <div className="bg-white-500 sm:px-3">
          <ul className="flex w-full justify-between items-center text-black-500">
            <LinkScroll
              ...
              className={`px-3 sm:px-4 py-2 flex flex-col items-center text-xs border-t-2 transition-all ${
                activeLink === "about" ? "border-purple-500 text-purple-500" : "border-transparent"
              }`}
            >
              <svg
                className="w-6 h-6"
            ...
            <LinkScroll
              ...
              className={`px-3 sm:px-4 py-2 flex flex-col items-center text-xs border-t-2 transition-all ${
                activeLink === "feature" ? "border-purple-500 text-purple-500" : "border-transparent"
              }`}  
            >
              <svg
                className="w-6 h-6"
            ...
            <LinkScroll
              ...
              className={`px-3 sm:px-4 py-2 flex flex-col items-center text-xs border-t-2 transition-all ${
                activeLink === "pricing" ? "border-purple-500 text-purple-500" : "border-transparent"
              }`}
            >
              <svg
                className="w-6 h-6"
            ...
            <LinkScroll
              ...
              className={`px-3 sm:px-4 py-2 flex flex-col items-center text-xs border-t-2 transition-all ${
                activeLink === "testimoni" ? "border-purple-500 text-purple-500" : "border-transparent"
              }`}
            >
              <svg
                className="w-6 h-6"
