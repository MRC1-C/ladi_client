...
const ProviderChat = () => {
    ...
    const [sendMess, { loading: ld, data: dataMess }] = useMutation(SendMess);
    ...
    return (
        <div className='w-full h-[calc(100vh-56px)] overflow-y-auto p-3'>
            ...
            <div className='flex gap-3'>
                <Input.TextArea placeholder='Nhập tin nhắn' value={input} onChange={e => setInput(e.target.value)} />
                <Button loading={ld} onClick={onSubmit} type='primary' className='h-[54px]'>Gửi</Button>
            </div>
        </div>
    )
}
